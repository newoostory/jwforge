...
2. Follow ALL instructions in that file exactly. It contains the complete 4-phase pipeline:
   ...
   - Phase 4: Verify (Analyzer + Tester subagents + Reviewer subagent + fix loop)
...
- After Phase 1 (M/L/XL), create a Team with TeamCreate, then add Architect teammate. Reviewer runs as a per-phase subagent (Phase 1/2/4).
